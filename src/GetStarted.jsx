    ...
    <>
      <div id="GetStarted">
        ...
        <div className="formContainer">
          <div className="form">
            <a
              href="https://form.jotform.com/242305756247155"
              id="form"
              target="_blank"
            >
              {" "}
          ...
          <div className="StartedContainer" id="Top">
            <div className="Steps" ref={TopRef}>
              ...
              <div className="Info">
                ...
                to provide information on the types of credit cards you have.
              </div>
            </div>
            <div className="Steps">
              ...
              <hr></hr>
              <div className="Info">
                Please email me at <b>hatecoachseats@gmail.com</b> once you've
                completed the credit card analysis form so we can discuss your
                goals and outline our next steps.
              </div>
            </div>
            <div className="Steps" ref={SecondRow}>
              ...
              <hr></hr>
              <div className="Info">
                If you have the right credit cards and enough points, I will
                help you book your next trip. If not, I will recommend which
                card to get and show you how to accumulate enough points for
                your future travels.
              </div>
            </div>
            <div className="Steps" ref={BottomRef2}>
              ...
              <hr></hr>
              <div className="Info">
                In six months, you’ll be enjoying the comfort of business class
                on your next trip.
              </div>
            </div>
          </div>
